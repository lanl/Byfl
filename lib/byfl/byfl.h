...
extern uint64_t  bf_run_number;          // User-defined number for the run
...
namespace bytesflops {
  ...
  extern void insert_basicblocks(uint64_t sec, uint64_t usec, uint64_t bbid, 
      uint64_t num_merged,
  ...
  extern void insert_instmix(uint64_t sec, uint64_t usec, const char* inst_type, 
      uint64_t tally);
  ...
  extern void binout_derived(uint64_t sec, uint64_t usec, ofstream* outstrm, 
