...
viewed with the
L<B<hpcviewer>|http://hpctoolkit.org/man/hpcviewer.html> GUI.
...
B<-bf-by-func> or, preferably, B<-bf-call-stack>.  (The latter enables
B<hpcviewer> to present measurements hierarchically.)
...
bfbin2csv(1), bfbin2hdf5(1), bfbin2sqlite3(1), bfbin2xmlss(1),
bf-clang(1), bf-clang++(1), bf-gcc(1), bf-g++(1), bf-gfortran(1),
