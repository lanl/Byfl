...
sqlite3(1), bfbin2csv(1), bfbin2hdf5(1), bfbin2xmlss(1), bf-clang(1),
bf-clang++(1), bf-gcc(1), bf-g++(1), bf-gfortran(1), bf-gccgo(1),
L<the Byfl home page|https://github.com/losalamos/Byfl/>, L<the SQLite
