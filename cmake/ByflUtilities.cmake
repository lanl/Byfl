...
function(tally_llvm_opcodes)
  ...
  set_var_to_process_output(
    ...
    COMMAND ${PERL_EXECUTABLE} ${PROJECT_SOURCE_DIR}/lib/byfl/gen_opcode2name "${CMAKE_C_COMPILER} ${CMAKE_C_FLAGS} -E" NUM
    )
  ...
  set_var_to_process_output(
    ...
    COMMAND ${PERL_EXECUTABLE} ${PROJECT_SOURCE_DIR}/lib/byfl/gen_opcode2name "${CMAKE_C_COMPILER} ${CMAKE_C_FLAGS} -E" NUM_POW2
    )
...
# modified to install into CMAKE_INSTALL_BYFL_PLUGIN_DIR instead of lib or
# lib64.  Also, various cases not relevant to Byfl were removed.
# =============================================================================
macro(byfl_add_llvm_loadable_module name)
  llvm_add_library(${name} MODULE ${ARGN})
  install(TARGETS ${name}
    LIBRARY DESTINATION ${CMAKE_INSTALL_BYFL_PLUGIN_DIR}
    )
